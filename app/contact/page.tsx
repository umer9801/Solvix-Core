...
export default function ContactPage() {
  ...
  const companyWhatsApp = "14315335035" // Updated company WhatsApp number ✅
          ...
          <form onSubmit={onSubmit} className="grid gap-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="grid gap-2">
                ...
                <Input id="email" name="email" type="email" required placeholder="info@solvixcore.com" /> {/* ✅ Updated */}
              </div>
              <div className="grid gap-2">
