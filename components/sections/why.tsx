  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-12 sm:py-16 animate-fade-up">
      <div className="grid gap-8 md:grid-cols-2">
        <div>
          <h2 className="text-balance text-2xl font-semibold tracking-tight text-glow">Why Solvix Core</h2>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-lg border p-5 card-glow">
          ...
          <div className="rounded-lg border p-5 card-glow">
            <p className="text-3xl font-semibold text-primary">A+</p>
            <p className="mt-1 text-sm text-muted-foreground">Accessibility & Core Web Vitals</p>
          </div>
          <div className="rounded-lg border p-5 card-glow">
            <p className="text-3xl font-semibold text-primary">99.9%</p>
