  ...
  return (
    <section className="mx-auto max-w-6xl px-4 pb-16 sm:pb-24 animate-fade-up">
      <div className="flex items-end justify-between gap-4">
        <h2 className="text-balance text-2xl font-semibold tracking-tight text-glow">Portfolio — Our Work</h2>
      </div>
      <div className="mt-6 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {toRender.map((p) => (
          <article key={p.title} className="overflow-hidden rounded-lg border card-glow">
      ...
      <div className="mt-8 flex justify-center">
        <button
          className="px-5 py-2 rounded-md btn-glow btn-float text-sm font-medium"
