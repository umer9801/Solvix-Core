...
import { C as SectionHead, E as TESTIMONIALS, O as TextReveal, S as STATS, b as Reveal, d as Marquee, g as PROCESS, i as CLIENTS, l as LuxButton, n as Blobs, o as Counter, w as SpotlightCard, x as SERVICES } from "./primitives-jA_iRMB7.mjs";
...
import { i as CtaBand } from "./router-B9drB22V.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-CwOjQ3cq.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute -top-20 -left-20 h-96 w-96 rounded-full bg-primary/20 blur-[80px]" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute top-10 right-0 h-80 w-80 rounded-full bg-violet/15 blur-[70px]" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute bottom-0 left-1/3 h-64 w-64 rounded-full bg-coral/12 blur-[60px]" })
				]
			}),
...
function StatsBand() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		className: "relative overflow-hidden py-20 text-background",
		style: { background: "linear-gradient(135deg, oklch(0.28 0.18 258) 0%, oklch(0.22 0.20 270) 40%, oklch(0.30 0.15 250) 100%)" },
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none absolute -left-20 top-0 h-96 w-96 rounded-full bg-violet/30 blur-3xl" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none absolute right-0 bottom-0 h-64 w-64 rounded-full bg-primary/25 blur-3xl" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: PROCESS.map((p, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
				delay: i * .07,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "group rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/5 to-background p-6 transition-all duration-300 hover:border-primary/50 hover:shadow-lift hover:from-primary/10",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
function WhyUs() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		className: "border-y border-primary/20 py-16",
		style: { background: "linear-gradient(160deg, oklch(0.945 0.028 248) 0%, oklch(0.938 0.032 268) 100%)" },
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "container-lux",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: TESTIMONIALS.map((t, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("figure", {
					className: "flex h-full flex-col rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/5 via-background to-violet/5 p-7 shadow-sm",
					children: [
...
function LeproPartnership() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "relative overflow-hidden rounded-3xl border border-primary/30 px-8 py-10 md:px-14 md:py-12",
			style: { background: "linear-gradient(135deg, oklch(0.88 0.09 252) 0%, oklch(0.92 0.06 270) 50%, oklch(0.90 0.07 248) 100%)" },
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none absolute -right-12 -top-12 h-48 w-48 rounded-full bg-primary/25 blur-3xl" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none absolute -bottom-10 -left-10 h-40 w-40 rounded-full bg-violet/20 blur-2xl" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
