...
import { C as SectionHead, D as TIMELINE, S as STATS, b as Reveal, k as VALUES, o as Counter, t as AWARDS, v as ParallaxImage } from "./primitives-Bw9MYgoN.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/about-BV9huQUQ.js
var import_jsx_runtime = require_jsx_runtime();
var office_team_default = "/assets/office-team-D_d1SaTh.jpg";
...
function About() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageHero, {
			...
			body: "Founded to make cutting-edge technology accessible for businesses in Canada, UK and Pakistan — at prices that make sense.",
			heroNote: "A lean, expert team that delivers AI, automation and web platforms with clarity, speed, and predictable outcomes.",
			meta: STATS.map((s) => ({
				k: `${s.value}${s.suffix}`,
				v: s.label
			}))
