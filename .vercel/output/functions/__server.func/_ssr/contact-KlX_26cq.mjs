...
import { C as SectionHead, a as COMPANY, b as Reveal, p as OFFICES, s as FAQS } from "./primitives-jA_iRMB7.mjs";
import { _ as MapPin, h as MessageCircle, m as Phone, u as Send, v as Mail } from "../_libs/lucide-react.mjs";
import { t as PageHero } from "./PageHero-KgwObnNr.mjs";
import { t as dashboard_default } from "./dashboard-F6NN-ziS.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/contact-KlX_26cq.js
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "We answer every inquiry within 24 hours with clear next steps."
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "rounded-[2rem] border border-border bg-card p-8",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							className: "mt-4 text-sm leading-relaxed text-muted-foreground",
							children: "WhatsApp, email and direct contact — choose the one that fits your workflow."
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "rounded-[2rem] border border-border bg-card p-8",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "eyebrow",
							children: "Project clarity"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-4 text-sm leading-relaxed text-muted-foreground",
							children: "Tell us the problem first, not the solution, and we’ll help you land on what matters."
						})]
					})
				]
			})
