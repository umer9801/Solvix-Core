...
import { b as Reveal, n as Blobs } from "./primitives-CLSdz6WR.mjs";
import { v as Link } from "../_libs/@tanstack/react-router+[...].mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/PageHero-DE44CvKF.js
var import_jsx_runtime = require_jsx_runtime();
function PageHero({ eyebrow, title, body, children, meta, image, imageAlt, landscape = false }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		className: "relative overflow-hidden pb-16 pt-10 md:pb-20 md:pt-14",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "pointer-events-none absolute inset-0 -z-10",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute -top-16 -left-16 h-72 w-72 rounded-full bg-primary/10 blur-[70px]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute top-0 right-0 h-56 w-56 rounded-full bg-primary/6 blur-[60px]" })]
			}),
