...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Cx3hVQpZ.js
...
var styles_default = "/assets/styles-BT8u6kBG.css";
...
function Nav() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
					className: cn("flex items-center justify-between rounded-2xl px-4 py-2.5 transition-all duration-500 md:px-5", scrolled ? "border border-border bg-white/95 shadow-soft backdrop-blur-2xl" : "border border-white/20 bg-white/80 backdrop-blur-md shadow-sm"),
					layout: true,
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
									to: "/services",
									className: "group flex items-center gap-1.5 rounded-xl px-3.5 py-2 text-sm font-medium text-foreground/70 transition-colors hover:bg-surface hover:text-foreground",
									children: ["Services", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.span, {
								...
								to: l.to,
								className: cn("rounded-xl px-3.5 py-2 text-sm font-medium transition-all duration-200", path === l.to ? "bg-primary/10 text-primary font-semibold" : "text-foreground/70 hover:bg-surface hover:text-foreground"),
								children: l.label
							}, l.to))]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Magnetic, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
									whileHover: { scale: 1.04 },
									whileTap: { scale: .97 },
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
										to: "/contact",
										className: "group hidden items-center gap-1.5 rounded-xl bg-primary px-4 py-2.5 text-sm font-semibold text-primary-foreground shadow-sm transition-all hover:bg-primary/90 hover:shadow-md sm:inline-flex",
										children: ["Get a Quote", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowUpRight, { className: "h-3.5 w-3.5 transition-transform duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" })]
									})
								}) }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.button, {
									whileHover: { scale: 1.05 },
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "card-lux rounded-2xl grid grid-cols-5 gap-6 p-6 shadow-lift",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "col-span-1 rounded-xl bg-primary/5 p-5 border border-primary/10",
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: "11 services. One team."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-2 text-xs text-muted-foreground leading-relaxed",
								children: "AI, automation, web, Shopify and more — all delivered from a single studio."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: "/services",
						...
						children: GROUPS.map((g) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							className: "space-y-1",
							children: SERVICES.filter((s) => s.group === g).map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: `/services/${s.slug}`,
								className: "group flex items-center gap-1.5 rounded-lg px-2 py-1.5 text-sm text-foreground/70 transition-all hover:bg-surface hover:text-primary",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRight, { className: "h-3 w-3 opacity-0 transition-opacity group-hover:opacity-100" }), s.title]
							}) }, s.slug))
						})] }, g))
					})]
				})
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnimatePresence, { children: mobile && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center justify-between px-5 py-4 border-b border-border bg-surface",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center gap-2.5",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "flex h-9 w-9 overflow-hidden rounded-xl bg-white ring-1 ring-border",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								src: "/assets/logo-DixoYNo1.PNG",
								alt: "Solvix Core",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [[{
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							to: l.to,
							onClick: () => setMobile(false),
							className: cn("flex items-center justify-between rounded-xl px-4 py-3.5 mb-1 text-sm font-medium transition-all", path === l.to ? "bg-primary/10 text-primary font-semibold" : "text-foreground hover:bg-surface hover:translate-x-1"),
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: l.label }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRight, { className: "h-4 w-4 text-muted-foreground" })]
						})
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: SERVICES.slice(0, 6).map((s, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
								initial: {
									opacity: 0,
									scale: .95
								},
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							children: ["Get a Free Quote ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowUpRight, { className: "h-4 w-4" })]
						})
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						].map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.a, {
							href: c.href,
							target: "_blank",
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("kbd", {
							className: "rounded-lg border border-border bg-surface px-2 py-1 font-mono text-[10px] text-muted-foreground",
							children: "ESC"
						})
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
					...
					children: results.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							className: "text-[11px] text-muted-foreground bg-surface px-2 py-0.5 rounded-full",
							children: s.group
						})]
					}) }, s.slug))
				})]
...
function Loader() {
	...
	(0, import_react.useEffect)(() => {
		...
		const t = setTimeout(() => setDone(true), 2e3);
		return () => {
			clearTimeout(t);
			clearInterval(interval);
		};
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnimatePresence, { children: !done ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-[500px] w-[500px] rounded-full bg-primary/8 blur-[120px]" })
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.p, {
					...
					children: "Premium Tech Solutions"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mt-10 h-px w-48 overflow-hidden rounded-full bg-border",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnimatePresence, { children: show ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageCircle, { className: "h-4 w-4" }), "Get a Quote"]
			})
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.button, {
			whileHover: {
				scale: 1.1,
...
var $$splitComponentImporter$12 = () => import("./routes-DDBCxil2.mjs");
...
var $$splitComponentImporter$11 = () => import("./about-BRa-HFFS.mjs");
...
var $$splitComponentImporter$10 = () => import("./blog-mIhXCJIx.mjs");
...
var $$splitComponentImporter$9 = () => import("./careers-BUBA5pPE.mjs");
...
var $$splitComponentImporter$8 = () => import("./contact-DgrP_8Y2.mjs");
...
var $$splitComponentImporter$7 = () => import("./faqs-DN9a-Vyk.mjs");
...
var $$splitComponentImporter$6 = () => import("./industries-B0S5ei4i.mjs");
...
var $$splitComponentImporter$5 = () => import("./projects-C6R-DxnR.mjs");
...
var $$splitComponentImporter$4 = () => import("./technologies-CaaH1VQw.mjs");
...
var $$splitComponentImporter$3 = () => import("./case-studies-PjpqTJhB.mjs");
...
var $$splitComponentImporter$2 = () => import("../_slug-DgifZzt3.mjs");
...
var $$splitComponentImporter$1 = () => import("./services-8Mjl_GU2.mjs");
...
var $$splitComponentImporter = () => import("../_slug-DDffmeNc.mjs");
